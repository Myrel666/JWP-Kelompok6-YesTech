...
<div class="main-panel">
    ...
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <form action="/updatehome/{{$home->id}}" method="POST" enctype="multipart/form-data">
            @csrf
          <h4 class="card-title">Home Form Edit</h4>
          ...
          <form class="forms-sample">
            ...
            <div class="row justify-content-end">
              <a href="{{ route('contributor.datahome') }}" class="btn btn-secondary mr-2">Cancel</a>
